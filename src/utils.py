...
def parse_arg():
    ...
    parser.add_argument('-batch_size', type=int, default=1, help="the batch size when active learning is disabled")
    parser.add_argument('-active_batch_size', type=int, default=1, help="fine_tune actively: active_batch_size out of active_sample_size")
    parser.add_argument('-active_sample_size', type=int, default=20, help="fine_tune actively: active_batch_size out of active_sample_size")
    ...
    parser.add_argument('-lr', type=float, default=1e-4, help="sgd: 10, adam: 0.001")
    parser.add_argument('-lamb', type=float, default=1e-2, help="value for decay btw distinctiveness & uncertainty")
    parser.add_argument('-gpuid', type=int, default=0)
    parser.add_argument('-seed', type=int, default=0)
    parser.add_argument('-epochs', type=int, default=1)
    parser.add_argument('-report_every', type=int, default=1)
    # whether to perform active learning (if not, only transfer learning is performed)
    parser.add_argument('-active', type=bool, default=True)    
    # whether to apply data augmentation
    parser.add_argument('-transform', type=bool, default=True)
    # whether to force choosing from one class each time. For binary active learning only
    parser.add_argument('-alternate', type=bool, default=False)   
    # whether to perform evaluation on evaluation set during training
    parser.add_argument('-eval', type=bool, default=True)
    parser.add_argument('-eval_every', type=int, default=1)
    parser.add_argument('-save', type=bool, default=False, help = "whether to save the fine-tuned model")
